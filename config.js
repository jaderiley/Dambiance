...
const CONFIG = {
  ...
  business: {
    name:      "D'ambiance",
    phone:     "+27 10 203 9360",
    whatsapp:  "+27 10 203 9360",
    address:   "24 2nd Rd, Sandton, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "D'ambiance — Cleaning services in sandton",
    description: "D'ambiance provides professional cleaning services in Sandton. 21 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Cleaning services · Sandton & surrounds",
    heroTitle:  "Spotless, every time — <em>professional cleaning.</em>",
    heroLead:   "D'ambiance provides professional domestic and commercial cleaning services across Sandton. Regular cleans, deep cleans and once-off services available.",
    ...
    band: {
      ...
      alt:   "D'ambiance team at work in Sandton",
      text:  "A clean home or office, every time — professional and reliable."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Serving Sandton and the surrounding area.",
    areasLead:  "We cover Sandton, Fourways, Midrand and the wider region. Regular contracts and once-off cleans both available.",
    ...
    // ─── REVIEWS ───────────────────────────────────────────
    reviewsTitle: "From 21 verified Google reviews.",
    reviews: [
      {
